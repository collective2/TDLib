...
namespace TDLib
{
    public partial class TDConnection
    {
        public List<Candle> Get30MinuteQuotes(string ticker,string accesstoken,int daysback)
        {
            ...
            string url = $"https://api.tdameritrade.com/v1/marketdata/{ticker}/pricehistory?apikey={ConsumerKey}&periodType=day&frequencyType=minute&frequency=30&startDate={startms}&endDate={endms}";
